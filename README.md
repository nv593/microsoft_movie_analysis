...
**Production Budget**
8100 million The production budget should be aimed to be at 100 million. It has a high potential to return double in profits of what is spent on production.
...
Please view full analysis in [Jupyter Notebook]
(  ./microsoft_movie_analysis.ipynb -- change to my own) or [presentation] (./)
